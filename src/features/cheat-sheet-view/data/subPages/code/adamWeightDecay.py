...
# @ref step-signature
def adam_step(params, grads, state, lr, beta1=0.9, beta2=0.999, eps=1e-8, weight_decay=0.0):
    """Classic Adam with coupled L2: moments use grad + weight_decay * param."""
# @end
# @ref no-grad
    with torch.no_grad():
# @end
...
# @end
# @ref weight-decay
            # Coupled decay: the penalty enters the moment buffers.
            if weight_decay != 0.0:
